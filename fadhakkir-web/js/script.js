...
document.querySelector(
  "html"
).style.backgroundImage = `linear-gradient(to bottom, ${secondary_color} -120%, ${primary_color} 60%)`;

//navigation theme
document.querySelector(".prayer-label").color = secondary_color;
document.querySelector(".prayer-nav-box").backgroundColor = primary_color;

document.querySelector(".setting-nav-icon").color = primary_color;
document.querySelector(".setting-nav-box").backgroundColor = secondary_color;
...
const main_code = (latitude, longitude) => {
  ...
  document.querySelector('.city-box').addEventListener('click', async function() {
    ...
    document.cookie = 'city=null; expires=Thu, 01 Jan 1970 00:00:00 UTC;'
    getCity(latitude, longitude);
  ...
  const get_current_date_cal = function() {
    document
  ...
  const scroll_to_month = function() {
    calender_el
  ...
  */
  ...
  const change_settings = function() {
    ...
    document.querySelectorAll(".nav-icon").forEach(function(el) {
      ...
      el.parentElement.classList.add("hidden3");
    });
    ...
    document.querySelector(".setting-nav-box").classList.remove("hidden3");
    document.querySelector(".setting-nav-box").style.marginRight = "0";

    document.querySelector(".add-icon").classList.add("hidden4");
    document.querySelector(".dhikr-icon").classList.remove("hidden4");

    document.querySelector(".prayer-nav-box").style.marginLeft = "5vw";

    document.querySelector(".setting-nav-label").style.color = primary_color;
    document.querySelector(
      ".setting-nav-box"
    ).style.backgroundColor = `${secondary_color}`;
    document.querySelector(
  ...
  const change_prayer = function() {
    ...
    document.querySelector(".setting-nav-box").style.marginRight = "5vw";
    document.querySelector(".prayer-nav-box").style.marginLeft = "0";

    document.querySelector(".add-icon").classList.add("hidden4");
    document.querySelector(".dhikr-icon").classList.remove("hidden4");

    document.querySelector(".prayer-nav-box").classList.remove("hidden3");

    document.querySelector(".prayer-label").style.color = primary_color; //'#000000dd';
    document.querySelector(
      ".prayer-nav-box"
    ).style.backgroundColor = `${secondary_color}`;
    document.querySelector(".prayer-icon").style.color = `${primary_color}`;
  };
  ...
  const change_dhikr = function() {
    ...
    document.querySelector(".add-icon").classList.remove("hidden4");
    document.querySelector(".dhikr-icon").classList.add("hidden4");

    document.querySelector(".dhikr-nav-box").classList.remove("hidden3");

    document.querySelector(".setting-nav-box").style.marginRight = "5vw";
    document.querySelector(".prayer-nav-box").style.marginLeft = "5vw";

    document.querySelector(".dhikr-label").style.color = primary_color; //'#000000dd';
    document.querySelector(
      ".dhikr-nav-box"
    ).style.backgroundColor = `${secondary_color}`;
    document.querySelector(".add-icon").style.color = `${primary_color}`;
  };
  ...
  document
    ...
    .addEventListener("click", function() {
      window.open(
        "mailto:muhammadabdullahbeeharry@gmail.com?subject=Feedback&body=Your app is fantastic!"
      );
    });
  ...
  document
    ...
    .addEventListener("click", function() {
      document
        .querySelector(".settings-section")
        .scrollIntoView();
  ...
  document
    ...
    .addEventListener("click", function() {
      document
        .querySelector(".prayer-times-section")
        .scrollIntoView();
  ...
  document
    ...
    .addEventListener("click", function() {
      //expanding dhikr add
      if (document.querySelector(".dhikr-nav-box").classList.contains("hidden3") === false) {
  ...
  //changing to prayer times on startup
  document.querySelector(
    ".navigation-box"
  ).style.backgroundImage = `linear-gradient(to top, ${primary_color} 10%, ${primary_color}00 100%)`;
...
function updateUI() {
  ...
  if (colourToChange) {
    ...
    update_theme();
    document.querySelector("html").style.backgroundImage = `linear-gradient(to bottom, ${secondary_color} -120%, ${primary_color} 60%)`;
    change_settings();
    getLunarPhase(new Date());
    select_method();
    get_current_date_cal();
...
(function init() {
    ...
    document.querySelectorAll(".dhikr-box").forEach(function(el) {
      el.addEventListener("click", function(e) {
        if (el.querySelector(".dhikr-context").classList.contains("hidden6") && e.target.classList.contains("part-context") !== true) {
          document.querySelector(".dhikr-pop-up").style.top = `${el.offsetTop - document.querySelector('.dhikr-section').scrollTop}px`
          document.querySelector(".dhikr-pop-up").classList.remove("hidden-counter");
          document.querySelector(".dhikr-pop-up").style.transform = `translateY(-${el.offsetTop - document.querySelector('.dhikr-section').scrollTop}px)`
  ...
  document.querySelector('.dhikr-pop-up-back-box').addEventListener('click', function() {
    ...
    document.querySelector(".dhikr-pop-up").style.transform = `translateY(0)`
  })
